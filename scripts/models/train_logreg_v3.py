...
def get_base_path():
    drive_base = "/content/drive/MyDrive/ADVERSARIAL_ML_PROJECT/data/segments_time"
    local_base = os.path.join(os.path.dirname(__file__), "..", "..", "data", "segments_time")
...
if __name__ == "__main__":
    print(f"\nRunning Logistic Regression v3 for segment {SEGMENT_ID}")
    ...
    print("\nLogistic Regression v3 pipeline completed.\n")
