# -*- coding: utf-8 -*-
"""
sensory_poison_v3structured.py (Colab Version)
...
Outputs one poisoned file per percentage.
"""
...
# >>> YOUR ACTUAL PROJECT ROOT IN GOOGLE DRIVE <<<
PROJECT_ROOT = Path("/content/drive/MyDrive/ADVERSARIAL_ML_PROJECT")

# Folder structure:
#   ADVERSARIAL_ML_PROJECT/data/segments_time/segment_01/
SEG_FOLDER = PROJECT_ROOT / "data" / "segments_time" / f"segment_{SEGMENT_ID}"

clean_file = SEG_FOLDER / f"Cleaned_Data_{SEGMENT_ID}.csv"

# Output folder for structured poisoning
...
def generate_sensory_poison_v3structured():
    print("Loading clean file:", clean_file)
