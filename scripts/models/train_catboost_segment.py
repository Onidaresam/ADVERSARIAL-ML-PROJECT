...
OUT_FOLDER = f"{SEG_FOLDER}/models_reducedscope/catboost"
...
if __name__ == "__main__":
    print(f"\nRunning CatBoost for segment {SEGMENT_ID}")
    ...
    # BASELINE
    print("[BASELINE] Training CatBoost on CLEAN data...")
    ...
    # ROBUSTNESS
    print(f"\n[ROBUSTNESS] Evaluating CatBoost clean-trained → {ATTACK} {PCT}%")
    ...
    # ADV TRAIN
    print(f"\n[ADV TRAIN] Training CatBoost on {ATTACK} {PCT}%")
