...
OUT_FOLDER = f"{SEG_FOLDER}/models_reducedscope/mlp"
...
if __name__ == "__main__":
    print(f"\nRunning MLP for segment {SEGMENT_ID}")
    ...
    # BASELINE
    print("[BASELINE] Training MLP on CLEAN data...")
    ...
    # ROBUSTNESS
    print(f"\n[ROBUSTNESS] Evaluating MLP clean-trained → {ATTACK} {PCT}%")
    ...
    # ADV TRAIN
    print(f"\n[ADV TRAIN] Training MLP on {ATTACK} {PCT}%")
