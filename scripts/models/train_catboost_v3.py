...
if __name__ == "__main__":
    print(f"\n[train_catboost_v3] Running CatBoost v3 for segment {SEGMENT_ID}")
    ...
    if args.mode in ["full", "adv_only"]:
        ...
        adv_models = train_cb_models(Xp_train, yp_train, DEVICE_STR)
    ...
    print("\ntrain_catboost_v3 pipeline completed.\n")
