...
def get_base_path():
    drive_base = "/content/drive/MyDrive/ADVERSARIAL_ML_PROJECT/data"
    local_base = os.path.join(os.path.dirname(__file__), "..", "..", "data")
...
def load_poisoned(attack, pct):
    if attack == "label_flip":
        ...
        Xp = dfp.iloc[:, :-1].values  # drop last column
...
if __name__ == "__main__":
    print(f"\nRunning MLP v3 for segment {SEGMENT_ID}")
    ...
    print("MLP v3 pipeline completed.")
