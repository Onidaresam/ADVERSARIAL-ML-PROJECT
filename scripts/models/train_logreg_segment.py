...
OUT_FOLDER = f"{SEG_FOLDER}/models_reducedscope/logreg"
...
if __name__ == "__main__":
    print(f"\nRunning Logistic Regression for segment {SEGMENT_ID}")
    ...
    # ========================================================
    print("[BASELINE] Training LogReg on CLEAN data...")
    ...
    # ========================================================
    print(f"\n[ROBUSTNESS] Evaluating LogReg clean-trained → {ATTACK} {PCT}%")
    ...
    # ========================================================
    print(f"\n[ADV TRAIN] Training LogReg on {ATTACK} {PCT}%")
